...
# 1) Tenga un método promedio(t1, t2) que reciba dos temperaturas (números) y retorne su promedio.
# 2) Tenga un método temperatura_mas_alta(*temperaturas) que retorne la temperatura más alta de todas las recibidas.
# 3) Tenga un atributo historial (una lista) donde se guarde cada promedio calculado.
